...
const CommentList = ({
	...
	return (
		<li className="group relative flex w-full flex-col rounded-lg bg-gray-100 p-2 transition-all hover:-translate-y-[2px] hover:shadow-sm md:hover:shadow-md">
			...
			<button
				...
				className="absolute top-[5px] right-[9px] transition-all focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-gray-500 md:opacity-0 md:group-hover:opacity-100"
			>
				<FontAwesomeIcon
